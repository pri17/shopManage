        ...
        <div class="site-mast__site-nav-w">
            <div class="site-mast__site-nav">
                <div class="site-mast__site-nav-inner">
                    <span class="mt-cates J-nav__trigger">原有商品</span>
                <nav>
                <ul class="navbar cf"><li class="navbar__item-w">
                <a class="navbar__item" href="goods/newgoods.jsp"><span class="nav-label">新进商品</span></a></li>
...
<div class="aspNetHidden">
    ...
    <label for="signup-username">商品编号</label>
    
                   
        <input name="ctl00$content$TextBox1" type="text" id="content_TextBox1" class="f-text smiddle-text user-name">
        <span id="content_RequiredFieldValidator4" class="inline-tip" style="color:Red;visibility:hidden;">商品编码不能为空</span>
       </div>
    ...
    <div class="field-group">
        ...
        <span id="content_RequiredFieldValidator9" style="color:Red;visibility:hidden;">商品原价不能为空</span>
        </div>
    ...
    <div class="field-group">
        ...
        <span id="content_RequiredFieldValidator10" style="color:Red;visibility:hidden;">商品售价不能为空</span>
        <span id="content_RegularExpressionValidator1" style="color:Red;visibility:hidden;">格式错误</span>
        </div>
  ...
  <option value="0">其他</option>
        ...
        <span id="content_RequiredFieldValidator11" style="color:Red;visibility:hidden;">选择商品类别</span>
        </div>
     ...
     <div class="field-group">
        ...
        <span id="content_RequiredFieldValidator12" style="color:Red;visibility:hidden;">商品数量不能为空</span>
        </div>
...
//<![CDATA[
    ...
    content_RequiredFieldValidator4.errormessage = "商品编号不能为空";
    ...
    content_RequiredFieldValidator9.errormessage = "商品原价不能为空";
    ...
    content_RequiredFieldValidator10.errormessage = "商品售价不能为空";
    ...
    content_RequiredFieldValidator11.errormessage = "商品类别";
    ...
    content_RequiredFieldValidator12.errormessage = "商品数量";
