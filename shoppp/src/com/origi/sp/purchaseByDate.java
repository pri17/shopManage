...
public class purchaseByDate extends HttpServlet{
	...
	protected void doPost(HttpServletRequest request,
		    ...
		    DB db=new DB();
			String p1=request.getParameter("d1");
			String p2=request.getParameter("d2");
			PrintWriter out=response.getWriter();
			JSONArray array = new JSONArray();	
			JSONObject member = null;
			member = new JSONObject();

			ArrayList al=db.getPurchaseByDate(p1,p2);
