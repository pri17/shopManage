...
public class SaleDAO {
	...
	public List<Sale> findByExample(Sale instance) {
		...
		try {
			List<Sale> results = (List<Sale>) getCurrentSession()
					.createCriteria("com.system.model.Sale")
	...
	public List<Sale> findByWorkDay(Object workDay) {
	...
	public List<Sale> findBySaleNum(Object saleNum) {
